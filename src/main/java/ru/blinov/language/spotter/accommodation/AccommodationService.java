...
public class AccommodationService {
	...
	public List<Accommodation> findAllAccommodationsByCenterByCityByCountryByLanguageName(String languageName, String countryName, String cityName, String centerName) {	
